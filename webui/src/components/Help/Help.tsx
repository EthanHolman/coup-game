      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <p className={styles.fullWidth}>
            ...
            cards, face-down, determine the actions you may take on your turn,
          ...
          <h2 className={clsx("margin", styles.fullWidth)}>Actions:</h2>
          ...
          <HelpCard
            ...
            description="Steal someone's coins"
          />
        </div>
      </div>
    </div>
